  ...
  const benefits = [
    {
      ...
      description:
        "Get your personalized recommendations in seconds, not minutes",
    },
    {
      icon: Shield,
      title: "Travel Insurance",
      description:
        "Complimentary travel insurance for all bookings worth up to $50,000",
    },
    {
      icon: Gift,
      title: "Exclusive Perks",
      description:
        "Access to VIP lounges, hotel upgrades, and special experiences",
    },
    {
      icon: Star,
      title: "Zero Booking Fees",
      description:
        "Save up to 15% on booking fees for hotels, flights, and activities",
    },
  ];

  const handleClick = (plan: any) => {
    if (plan.price > 0) {
      router.push(`/premium/payment?plan=${plan.name.toLowerCase()}`);
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Unlock advanced AI features, exclusive deals, and premium travel
            experiences
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-emerald-600 to-teal-700 rounded-3xl p-12 text-center text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join 50,000+ premium travelers worldwide
          </p>
          <button
            onClick={() => router.push("/premium/payment?plan=premium")}
